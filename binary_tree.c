// by Noel John Robert
// program to implement Binary Search Tree & its operations

// C, not Java (Replit filename error)
...
int main()
{
	...
	do
	{
		...
		switch(code)
		{
			case 1: printf("Input element to insert: "); 
              scanf("%d", &num);
							insert(num); break;
			...
			case 3: printf("Input element to delete: "); 
              scanf("%d", &num);
							deletion(num); break;
			...
			case 5: printf("Inorder sequence: "); inorder_traversal(root); 
        printf("\n");
							printf("Preorder sequence: "); preorder_traversal(root); 
        printf("\n");
							printf("Postorder sequence: "); postorder_traversal(root); 
        printf("\n");
							break;
